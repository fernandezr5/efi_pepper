...
inputdata <- c(
  ...
  # This is a de-identified table of all HbA1c values indexed by patient_num and
  # start_date. It is all patients, not just the 40% sample, so in principle we
  # might never need to rebuild it-- just keep re-linking it to the latest
  # version of `samplecsv`.
